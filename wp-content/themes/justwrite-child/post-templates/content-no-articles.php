...
<!--		<h2>--><?php //_e( 'It looks like nothing was found.', 'justwrite' ); ?><!--<br /><a href="#" class="try-a-search">--><?php //ac_icon( 'search' ) . ' ' . _e( 'Maybe try another search?', 'justwrite' ) ?><!--</a></h2>-->
        		<h2><?php _e( 'Không tìm thấy kết quả phù hợp !', 'justwrite-child' ); ?><br /><a href="#" class="try-a-search"><?php ac_icon( 'search' ) . ' ' . _e( 'Hãy thử lại với từ khóa khác !', 'justwrite-child' ) ?></a></h2>
    <?php } else { ?>
<!--    	<h2>--><?php //_e( 'No posts found. Maybe add some! :)', 'justwrite' ); ?><!--</h2>-->
            	<h2><?php _e( 'Không tìm thấy kết quả phù hợp ! :)', 'justwrite-child' ); ?></h2>
    <?php } ?>
    </header>
